...
export type OperationMarkShipmentDispatchedMutation = { markShipmentDispatched: { replayed: boolean, shipment: { recipientTaxId: string, addressLine: string, deliveryNotes: string, dispatchedAt: unknown, deliveredAt: unknown, updatedAt: unknown, publicUrl: string, id: string, number: string, status: string, statusLabel: string, deliveryMode: string, recipientName: string, commune: string, region: string, carrier: string, trackingCode: string, trackingUrl: string, nextAction: string, allowedActions: Array<string>, createdAt: unknown, confirmation: { outcome: string, comment: string, createdAt: unknown } | null, latestLabel: { id: string, downloadUrl: string | null, expiresAt: unknown, createdAt: unknown, fileName: string } | null, timeline: Array<{ id: string, eventType: string, fromStatus: string, toStatus: string, title: string, detail: string, isPublic: boolean, actorName: string, createdAt: unknown }>, activeTicket: { id: string, number: string, status: string, statusLabel: string, category: string, categoryLabel: string, createdAt: unknown } | null, tickets: Array<{ id: string, number: string, status: string, statusLabel: string, category: string, categoryLabel: string, createdAt: unknown }>, followUps: Array<{ id: string, kind: string, kindLabel: string, status: string, statusLabel: string, dueAt: unknown, sentAt: unknown, parameterKey: string, parameterSource: string, parameterSourceLabel: string, parameterLabel: string }>, returnCases: Array<{ id: string, kind: string, kindLabel: string, notes: string, stockConfirmedAt: unknown, createdAt: unknown }>, nextFollowUp: { id: string, kind: string, kindLabel: string, status: string, statusLabel: string, dueAt: unknown, sentAt: unknown, parameterKey: string, parameterSource: string, parameterSourceLabel: string, parameterLabel: string } | null, order: { id: string, number: string, status: string } } } };
