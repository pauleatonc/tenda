...
export type OperationViewerQuery = { viewer: { id: string, email: string, emailVerified: boolean, profile: { id: string, fullName: string, phone: string, locale: string, photoUrl: string | null } } | null, organisation: { id: string, name: string, timezone: string, phone: string, businessEmail: string, address: string, description: string, logoUrl: string | null } | null, activeInventory: { id: string, name: string } | null, activeMembership: { id: string, role: string, roleLabel: string, permissions: { viewFinancials: boolean, manageMembers: boolean, manageSensitiveConfiguration: boolean, manageInventorySchema: boolean } } | null };

export type OperationOrganisationMembersQueryVariables = Exact<{ [key: string]: never; }>;


export type OperationOrganisationMembersQuery = { members: Array<{ id: string, email: string, fullName: string, role: string, roleLabel: string, permissions: { viewFinancials: boolean, manageMembers: boolean, manageSensitiveConfiguration: boolean, manageInventorySchema: boolean } }> };
...
export type OperationUpdateOrganisationMutation = { updateOrganisation: { organisation: { id: string, name: string, timezone: string, phone: string, businessEmail: string, address: string, description: string, logoUrl: string | null } } };
...
export type OperationAddOrganisationMemberMutation = { addOrganisationMember: { member: { id: string, email: string, fullName: string, role: string, roleLabel: string } } };
...
export type OperationUpdateOrganisationMemberMutation = { updateOrganisationMember: { member: { id: string, email: string, fullName: string, role: string, roleLabel: string, permissions: { viewFinancials: boolean, manageMembers: boolean, manageSensitiveConfiguration: boolean, manageInventorySchema: boolean } } } };
