...
class Organisation(models.Model):
    ...
    bank_account_type = models.CharField(max_length=32, blank=True)
    bank_account_number = models.CharField(max_length=32, blank=True)
    bank_holder_tax_id = models.CharField(max_length=16, blank=True)
    bank_confirmation_email = models.EmailField(blank=True)
